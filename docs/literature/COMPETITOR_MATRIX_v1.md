...
|---|---|---|---|---|---|---|---|---|---|
| BBNet | arXiv `2512.15266v1`, 2025-12-17; canonical code `ML4GW/BBNet@9bd5147`; earlier package `Hdiao112/BBNet@ea66fe6` | PArthENoPE/AlterBBN abundance emulator for extended cosmology | central-value emulator in public source | yes: dark radiation and stiff EOS in training solvers | no | embeddable | [canonical repository](https://github.com/ML4GW/BBNet), MIT; [earlier lineage](https://github.com/Hdiao112/BBNet), nested MIT | partial: training/evaluation source is public; canonical `weights` is a one-byte placeholder; no checkpoints, scalers, data, modified solvers or exact environment; train/evaluate schemas are inconsistent | calibrated distributional UQ, nuisance variables, complete artifacts, solver/rate decomposition |
