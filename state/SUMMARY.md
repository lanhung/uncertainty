...
_Generated: 2026-07-22T21:18:33+00:00; revision: 455_
...
Status counts — running: 3, pending: 14, done: 12, cancelled: 27

## Next runnable
- **EXEC-SECOND-WORKER-CAPACITY** — Register a second AutoDL worker only when free from other projects

## Live now
- **P0-WHY-NOT-01** — Complete direct-solver necessity and emulator-economics memo for the UQ workload [running]
