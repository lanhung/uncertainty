...
_Generated: 2026-07-22T19:43:56+00:00; revision: 275_

**Scientific program gate: 21%.** This is effort-weighted gate completion, not scientific confidence.
**Current execution milestones: 33%.**

Status counts — stale: 2, blocked: 2, pending: 25, done: 10

## Next runnable
- **EXEC-ABCMB-FULL-AUDIT** — Execute frozen ABCMB spectra, gradient, toy-Fisher and synthetic audits
- **EXEC-HEARTBEAT-OFFLINE-E2E-v1** — Validate offline heartbeat buffering, checkpointing, replay and lease release
...
- **EXEC-HEARTBEAT-OFFLINE-E2E-v1** — Validate offline heartbeat buffering, checkpointing, replay and lease release [pending]
  - progress: 0% (0/8 checks); ETA: —
  - note: PR #60 froze eight offline-buffer/checkpoint/replay/lease/gate-invariance checks; implementation must precede any real ledger replay.
  - artifacts: [configs/ops/offline_heartbeat_e2e_v1.yaml](https://github.com/lanhung/uncertainty/blob/main/configs/ops/offline_heartbeat_e2e_v1.yaml)
