...
_Generated: 2026-07-22T13:49:49+00:00; revision: 251_

**Scientific program gate: 21%.** This is effort-weighted gate completion, not scientific confidence.
**Current execution milestones: 83%.**

Status counts — running: 1, stale: 2, blocked: 2, pending: 21, done: 9

## Live now
- **EXEC-ABCMB-CONVERGENCE** — Execute the frozen ABCMB bundled-LINX convergence V2 cases [running]
  - progress: 67% (4/6 cases); ETA: 2026-07-22T13:52:20+00:00 (measured)
  - owner: vultr; attempt: 4; run_id: —
  - heartbeat age: 92 s
  - note: westb run-20260722T134322Z: verified PROGRESS 4/6; first weak-rate sampling case completed, lease held
