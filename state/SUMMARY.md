...
_Generated: 2026-07-22T13:36:40+00:00; revision: 237_

**Scientific program gate: 21%.** This is effort-weighted gate completion, not scientific confidence.
**Current execution milestones: 50%.**

Status counts — running: 1, stale: 1, blocked: 2, pending: 22, done: 9

## Next runnable
- **EXEC-ABCMB-CONVERGENCE** — Execute the frozen ABCMB bundled-LINX convergence V2 cases
...
- **P0-WHY-NOT-01** — Write why-not-LINX/PRyMordial/PRIMAT and emulator economics memo [running]
  ...
  - note: PR #54 merged at main 9a1faa0. ABCMB consistency V1 executed all 8/8 frozen cases with zero failures, but tolerance plateau 0.0047691 sigma and weak-rate sampling plateau 0.0274556 sigma both exceed the frozen 0.001 sigma limit. Execution is complete; numerical acceptance is rejected, WHY-NOT remains 0/1, and no science-gate progress is awarded.
...
## Pending
- **EXEC-ABCMB-CONVERGENCE** — Execute the frozen ABCMB bundled-LINX convergence V2 cases [pending]
  - progress: 0% (0/6 cases); ETA: —
  - note: PR #56 merged. Execution-only tracker created for six preregistered ABCMB convergence V2 cases; acceptance remains a separate scientific decision.
