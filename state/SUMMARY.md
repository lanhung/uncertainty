...
_Generated: 2026-07-22T20:51:06+00:00; revision: 294_
...
Status counts — stale: 2, blocked: 2, pending: 24, done: 11

## Next runnable
- **EXEC-ABCMB-FULL-AUDIT** — Execute frozen ABCMB spectra, gradient, toy-Fisher and synthetic audits
- **EXEC-LINX-GRADIENT** — Execute frozen LINX standard-neighborhood gradient diagnostics
...
## Pending
- **EXEC-ABCMB-FULL-AUDIT** — Execute frozen ABCMB spectra, gradient, toy-Fisher and synthetic audits [pending]
  - progress: 0% (0/4 components); ETA: —
  - note: PR #60 froze exact-source CPU-only spectra, gradient, toy-Fisher and Asimov scopes before implementation; formal Fisher, real posterior and HMC/NUTS remain unavailable.
...
- **EXEC-LINX-GRADIENT** — Execute frozen LINX standard-neighborhood gradient diagnostics [pending]
  - progress: 0% (0/4 groups); ETA: —
  - note: PR #60 froze the standard-neighborhood AD/FD diagnostic; the historical extreme all-2 vector is diagnostic-only and cannot decide acceptance-domain validity.
