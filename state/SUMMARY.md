...
_Generated: 2026-07-22T13:38:24+00:00; revision: 242_
...
Status counts — running: 2, stale: 1, blocked: 2, pending: 21, done: 9
...
- **EXEC-ABCMB-CONVERGENCE** — Execute the frozen ABCMB bundled-LINX convergence V2 cases [running]
  ...
  - heartbeat age: 0 s
  - note: Attempt 1 failed before measurement because the launcher referenced an unavailable generic python command; lease released cleanly and no artifact was created. Attempt 2 run-20260722T133815Z uses the exact locked solver-cpu interpreter.
