...
_Generated: 2026-07-22T13:40:39+00:00; revision: 243_
...
Status counts — running: 1, stale: 1, blocked: 2, failed: 1, pending: 21, done: 9
...
## Failed
- **EXEC-ABCMB-CONVERGENCE** — Execute the frozen ABCMB bundled-LINX convergence V2 cases [failed]
  - progress: 0% (0/6 cases); ETA: —
  - owner: vultr; attempt: 2; run_id: —
  - note: attempt 2 stopped before scanner launch because allow-offline-start did not catch a low-level TimeoutError; lease released and no measurement artifact was created
